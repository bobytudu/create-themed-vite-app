...
import instacartImg from "assets/img/brands/instacart.png";
import kickstarterImg from "assets/img/brands/kickstarter.png";
import lyftImg from "assets/img/brands/lyft.png";
import shopifyImg from "assets/img/brands/shopify.png";
import pinterestImg from "assets/img/brands/pinterest.png";
import twitterImg from "assets/img/brands/twitter.png";
import avatar2Img from "assets/img/team/avatar2.jpg";
import avatar4Img from "assets/img/team/avatar4.jpg";
import avatar5Img from "assets/img/team/avatar5.jpg";
      ...
      <section className="py-5">
        ...
        >
          ...
          >
            <a href="#">
              {" "}
              <img className="m-3" src={instacartImg} />
            </a>
            <a href="#">
              {" "}
              <img className="m-3" src={kickstarterImg} />
            </a>
            <a href="#">
              {" "}
              <img className="m-3" src={lyftImg} />
            </a>
            <a href="#">
              {" "}
              <img className="m-3" src={shopifyImg} />
            </a>
            <a href="#">
              {" "}
              <img className="m-3" src={pinterestImg} />
            </a>
            <a href="#">
              {" "}
              <img className="m-3" src={twitterImg} />
            </a>
          </div>
        </div>
      </section>
